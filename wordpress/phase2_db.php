...
*/
 ...
 $ACCESS_PWD = 'Welcome@456'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"pbls_usr",#required
 'pwd'=>"pbls_pwd_admin", #required
 'db'=>"eleva_2017",  #optional, default DB
 'host'=>"",#optional
 'port'=>"",#optional
